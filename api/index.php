...
$customhead="<link rel=\"stylesheet\" href=\"/css/api.css\">";
$customhead.="<script src=\"/js/api.js\"></script>";
$pagetitle="API Playground";
echo(htmlhead($pagetitle,$customhead));
echo(navbar());
?>
<body>
<div class="api-main">
 ...
 <details id="api-dropdown">
  <summary class="api-dropdown-title" >
        Map Endpoints
</summary>
    ...
    <div class="api-container">
        ...
        <div id="all-form">
            <label class="api-label" for="dial">Dial (0 for all, 1 for filtered):</label>
            <input class="input" type="number" data-urlpart="dial" id="dial" placeholder="0">
        ...
        <div id="search-form">
            <label class="api-label"  for="q">Query (<strong>q</strong>):</label>
            <input required="" class="input" type="text" data-urlpart="q" id="q" placeholder="Enter search term">
            
            <label class="api-label"  for="a">Amount (<strong>a</strong>):</label>
            <input class="input" type="number" data-urlpart="a" id="a" placeholder="10">
            
            <label class="api-label"  for="w">Search in (<strong>w</strong>):</label>
            <select class="input" data-urlpart="w" id="w">
                <option value="both">Both</option>
                <option value="name">Name</option>
                <option value="dial">Dial</option>
            </select>
            
            <label class="api-label"  for="d">Dial Filter (<strong>d</strong>):</label>
            <input class="input" type="number" data-urlpart="d" id="d" placeholder="0">
...
<div class="response-container">
  ...
  <h3 id="info_railline"><strong>Info Railline API</strong></h3>
        ...
        <div id="info_railline-form">
            <label class="api-label"  for="id">ID (<strong>id</strong>):</label>
            <input required=""  class="input" type="number" data-urlpart="id" id="id" placeholder="Enter ID">
...
<div class="response-container">
    ...
    <pre class="api-pre json-container" id="info-response">Response will appear here...</pre>
        ...
        <div class="explanation">
			...
			<div id="cords-form">
    <label class="api-label"  for="x">X Coordinate (<strong>x</strong> <span class="required">(required)</span>):</label>
    <input class="input" type="number" data-urlpart="x" id="x" placeholder="Enter X coordinate" required>
    <p>Example: <code>x=420</code></p>
    <label class="api-label" for="z">Z Coordinate (<strong>z</strong> <span class="required">(required)</span>):</label>
    <input class="input" type="number" data-urlpart="z" id="z" placeholder="Enter Z coordinate" required>
    <p>Example: <code>z=69</code></p>

    <label class="api-label"  for="r">Radius (<strong>r</strong> - optional):</label>
    <input class="input" type="number" data-urlpart="r" id="r" placeholder="256">
    <p>Example: <code>r=128</code></p>

    <label class="api-label"  for="a">Amount (<strong>a</strong> - optional):</label>
    <input class="input" type="number" data-urlpart="a" id="a" placeholder="10">
    <p>Example: <code>a=1</code></p>

    <label class="api-label"  for="d">Dial Filter (<strong>d</strong> - optional):</label>
    <input class="input"  type="number" data-urlpart="d" id="d" placeholder="0">
    <ul>
...
<div class="explanation">
            ...
            <p>Example: `id=43`</p>
               ...
               <div id="shot-form">
<label class="api-label" for="x">Dial ID (<strong>id</strong> <span class="required">(required)</span>):</label>
            <input required="" class="input" type="nuber" data-urlpart="id" id="id" placeholder="Enter ID">
