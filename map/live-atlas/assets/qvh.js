...
function checkFlag() {
    if(!window.liveAtlasLoaded) {
        ...
        style.textContent = [
            '#qvh-search-panel {',
            '    position: fixed; left: 6.5rem; top: 24.7rem; z-index: 9999;',
            '    width: 280px; background: #1a1b26; border-radius: 0.375rem;',
            '    color: #c0caf5; font-family: "Fira Code", monospace; font-size: 15px;',
            '    display: none; flex-direction: column; max-height: 60vh; overflow: hidden;',
            '    box-shadow: 0 2px 8px rgba(0,0,0,0.5);',
            '}',
            '#qvh-search-panel.open { display: flex; }',
            '#qvh-search-input {',
            '    background: #1a1b26; border: none;',
            '    border-bottom: 1px solid rgba(255,255,255,0.1);',
            '    color: #c0caf5; padding: 0.5rem 0.75rem;',
            '    font-family: inherit; font-size: 15px; outline: none;',
            '    width: 100%; box-sizing: border-box; border-radius: 0.375rem 0.375rem 0 0;',
            '}',
            '#qvh-search-input::placeholder { color: #6c7086; }',
            '#qvh-search-results { overflow-y: auto; flex: 1; background: #1a1b26; }',
            '.qvh-result { padding: 0.5rem 0.75rem; border-bottom: 1px solid rgba(255,255,255,0.05); cursor: pointer; transition: background 0.1s; font-size: 15px; }',
            ...
            '#qvh-search-header { padding: 0.35rem 0.75rem; background: #1a1b26; color: #6c7086; font-size: 12px; border-bottom: 1px solid rgba(255,255,255,0.1); display: flex; justify-content: space-between; align-items: center; }',
        ...
        panel.innerHTML = '<input id="qvh-search-input" type="text" placeholder="Search markers...">' +
            '<div id="qvh-search-header"><span>Dial Search</span><span id="qvh-result-count"></span></div>' +
